    ...
    <form action="{{ route('admin.subcategory.store')}}" method="POST" >
      ...
      <div class="form-raw">
        ...
        <div class="form-raw">
          ...
          <div class="form-txtfld">
            @if(Route::is('admin.subcategory.edit'))
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="admintable">
    ...
    @foreach($subcategories as $key=>$subcategory)
      <tr>
        ...
        <td align="left" valign="top">{{ $subcategory->category->name }}</td>
        <td align="left" valign="top">{{ $subcategory->name }}</td>
        <td align="left" valign="top">
          <a href="{{ route('admin.subcategory.show', Crypt::encrypt($subcategory->id)) }}">
        ...
        <td align="left" valign="top"><a href="{{ route('admin.subcategory.edit', Crypt::encrypt($subcategory->id)) }}"">Edit</a></td>
        <td align="center" valign="top">
          <form method="POST"  action="{{ route('admin.subcategory.destroy', Crypt::encrypt($subcategory->id)) }}">
            @csrf
            @method('DELETE')
